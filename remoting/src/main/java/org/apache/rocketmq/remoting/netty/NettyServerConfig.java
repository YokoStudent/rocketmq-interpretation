...
public class NettyServerConfig implements Cloneable {
    ...
    /**
     * IO线程池线程个数，主要时NameServer、Broker端解析请求，返回响应的线程个数，这类线程主要是处理网络请求的，解析请求包，
     * 然后转发到各个业务线程池完成具体的业务操作，然后讲结果再返回调用方
     */
